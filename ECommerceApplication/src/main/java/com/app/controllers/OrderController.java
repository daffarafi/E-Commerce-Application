...
public class OrderController {
	...
	public ResponseEntity<OrderDTO> orderProducts(@PathVariable String email, @PathVariable Long cartId, @PathVariable String paymentMethod,  @RequestBody PaymentCreditCardDTO paymentDTO) {
		OrderDTO order = orderService.placeOrder(email, cartId, paymentMethod, paymentDTO );
